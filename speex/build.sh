...
## NOTE: The speex 'make' process fails when building
## the command-line 'speexenc' tool. This does not stop
## the library or framework from building successfully.
...
for lib in "${FWKS[@]}"; do
  ...
  for hfile in `find $lname -type f`; do
